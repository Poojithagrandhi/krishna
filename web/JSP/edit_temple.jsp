                    ...
                    <div class="product col-md-3" style="border:2px solid pink;padding: 20px;background: white">
                                <div class="product-img">
                                    <center> 
                                        ...
                                        <a href="edit3.jsp?a=<%=rs.getString("tempid")%>&b=<%=rs.getString("name")%>&c=<%=rs.getString("description")%>"><img src="../img/edit.jpg"  height="20" width="20"/></a>
                                        <a href="delete3.jsp?a=<%=rs.getString("tempid")%>"><img src="../img/delete.jpg"  height="20" width="20"/></a>
                                    </center>
                                </div>
                    </div>
