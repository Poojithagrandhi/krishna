...
<html lang="en">
  ...
  <body id="page-top" style="background-color: lavender">
<%
                    ...
                    <div class="product col-md-3" style="border:2px solid pink;padding: 20px;background: white">
                                <div class="product-img">
                                    ...
                                    <center> 
                                        ...
                                        <a href="edit.jsp?a=<%=rs.getString("bookid")%>&b=<%=rs.getString("name")%>&c=<%=rs.getString("description")%>&d=<%=rs.getString("author")%>&e=<%=rs.getString("publisher")%>"><img src="../img/edit.jpg"  height="20" width="20"/></a>
                                        <a href="delete.jsp?a=<%=rs.getString("bookid")%>"><img src="../img/delete.jpg"  height="20" width="20"/></a>
