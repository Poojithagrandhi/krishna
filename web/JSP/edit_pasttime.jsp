                    ...
                    <div class="product col-md-3" style="border:2px solid pink;padding: 20px;background: white">
                                <div class="product-img">
                                    ...
                                    <center> 
                                        ...
                                        <a href="edit2.jsp?a=<%=rs.getString("pastid")%>&b=<%=rs.getString("title")%>&c=<%=rs.getString("description")%>"><img src="../img/edit.jpg"  height="20" width="20"/></a>
                                        <a href="delete2.jsp?a=<%=rs.getString("pastid")%>"><img src="../img/delete.jpg"  height="20" width="20"/></a>
                                    </center>
                                </div>
                    </div>
