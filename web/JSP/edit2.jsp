      ...
      <div class="col-md-6 ">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <tr >
                    <th>Title</th>
                    <td> <input type="text" class="form-control" name="tit" value="<%= request.getParameter("b") %>"  required="required"/></td></tr>
                ...
                String id=request.getParameter("id");
                        ...
                        PreparedStatement ps=con.prepareStatement("update pasttime set title=?, description=? where pastid=?");
                        ...
                        if(rs==0)
                        {
                            ...
                            <div class="alert-danger" style="padding: 20px">
                                FAILED TO UPDATE PAST-TIME DETAILS
                            </div>
                            <%
                        }
                        else
                        {
                            ...
                            <div class="alert-success" style="padding: 20px">
                                SUCCESSFULLY UPDATED PAST-TIME DETAILS
                            </div>
                            <%
                        }
                        }
