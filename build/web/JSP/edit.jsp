          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="edit_temple.jsp">temple </a>
              ...
              <span><b><a href="logout.jsp" style="color: burlywood;text-decoration: none">LOGOUT</a></b></span>
                         ...
                         <div class="container">
      <div class="col-md-6 ">
        <div class="card-header bg-warning">UPDATE BOOK</div>
        <div class="card-body">
                    <form action="" method="post" >
            <div class="form-group">
                <tr >
                    <th>Book ID</th>
                    <td> <input type="text" class="form-control" name="id"  value="<%= request.getParameter("a") %>" required="required"/></td></tr>
            
                <div class="form-group">
                <tr>
                    <th>Book Name</th>
                    <td><input type="text" class="form-control" name="name" value="<%= request.getParameter("b") %>" /></td></tr>
            </div>
                <div class="form-group">
                <tr>
                    <th>Book Description</th>
                    <td><input type="text" class="form-control" name="desc" value="<%= request.getParameter("c") %>"></td></tr>
            </div>
                <div class="form-group">
                <tr>
                    <th>Author</th>
                    <td><input type="text" class="form-control" name="aut" value="<%= request.getParameter("d") %>" /></td></tr>
            </div>
                <div class="form-group">
                <tr>
                    <th>Publisher</th>
                    <td><input type="text" class="form-control" name="pub"  value="<%= request.getParameter("e") %>"/></td></tr>
            </div>
                <div class="form-group">
                ...
                String id=request.getParameter("id");
                        ...
                        PreparedStatement ps=con.prepareStatement("update books set name=?, description=?,author=?,publisher=? where bookid=?");
                        ...
                        else
                        {
                            ...
                            <div class="alert-success" style="padding: 20px">
                                SUCCESSFULLY UPDATED BOOK DETAILS
                            </div>
                            <%
                        }
                        }
