    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      ...
      <div class="breadcrumb" style="background-color: white">
				...
				<div class="product-btns">
                                    <table>
                                        <tr >
                                            <td style="padding:2px 20px 0px 20px"><a href="up1.jsp?msg=<%=rs.getString("imgid")%>"><img src="../img/up.jpg" width="40px" height="40px"/></a></td>
                                            <td style="padding:2px 20px 0px 20px"><a href="down1.jsp?msg=<%=rs.getString("imgid")%>"><img src="../img/down.jpg" width="40px" height="40px"/></a></td>
                                            <td style="padding:2px 20px 0px 20px"><a href="comment.jsp?msg=<%=rs.getString("imgid")%>"><img src="../img/comment.jpg" width="40px" height="40px"/></a></td>
                                    </tr>
                                    <tr>
