        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <tr>
                    ...
                    <td><textarea class="form-control" name="desc"  style="width: 400px;height: 200px"></textarea></td></tr>
            </div>
                <div class="form-group">
                <tr>
                    <th>Book Image</th>
                ...
                <tr>
                    <th>Author</th>
                    <td><input type="text" class="form-control" name="aut"  /></td></tr>
            </div>
                <div class="form-group">
                <tr>
                    <th>Publisher</th>
                    <td><input type="text" class="form-control" name="pub"  /></td></tr>
            </div>
                <div class="form-group">
                ...
                String id=mr.getParameter("id");
                        ...
                        String aut=mr.getParameter("aut");
                        String pub=mr.getParameter("pub");
                        
                        connects co=new connects();
                        Connection con=co.con();
                        PreparedStatement ps=con.prepareStatement("insert into books(fileName,fileData,fileType,publisher,author,bookid,name,description) values(?,?,?,?,?,?,?,?)");
